const kujiImages = Array.from({ length: 439 }, (_, i) => `url("../img_kuji/kuji${String(i + 1).padStart(5, '0')}.jpg")`);
...
function displayRandomKujiImage() {
    ...
    if (kujiImagesLoaded.length > 0) {
        ...
        if (isCeilingEnabled && switchCount >= 49) {  // 50回目で天井が有効の場合
            ...
            const ceilingImages = [
                'url("../img_kuji/kuji00001.jpg")',
                'url("../img_kuji/kuji00002.jpg")',
                'url("../img_kuji/kuji00003.jpg")',
                'url("../img_kuji/kuji00004.jpg")',
                'url("../img_kuji/kuji00005.jpg")'
            ];
            // 5つの画像の中からランダムに1つを選択
